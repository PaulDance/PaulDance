...
\begin{itemize}
    ...
    \item Quand toutes ces étapes-là sont bien complétées, le projet est en
        ...
        contrat le besoin d'aussi pouvoir gérer les systèmes eux-mêmes, il devra
        alors ouvrir un ticket auprès du \gls{ocd-build} afin que ces derniers
        appliquent le changement souhaité. Un tarif au ticket ou groupe de
        tickets est appliqué.
...
bien encore d'en soumettre à de grosses charges afin de déterminer si les
