...
remplie afin d'acter que les tests s'étaient bien déroulés à ce moment-là. Un
exemple d'un telle fiche est présenté en Annexe~\ref{sec:annexes::doc-hy}
(Figure~\ref{fig:doc-hy/fcq}).
...
fin de ma période de stage. Le plan du \gls{dsd} est présenté en
