\newglossaryentry{integ}{%
    name = intégration,
    description = {%
        L'intégration de système est une activité d'ingénierie qui relève du
        processus de mise en relation de différents systèmes, souvent
...
}]{mcs}{MCS}{Maintien en Conditions de Sécurité}
...
\newacronym[description = {%
    ou <<Infrastructure à Clés Publiques>> est un ensemble de rôles, politiques,
    machines, logiciels et procédures nécessaires pour créer, gérer, distribuer,
    utiliser, stocker et révoquer des certificats numériques et ainsi gérer les
    opérations récurrentes liées à l'utilisation de la cryptographie à clé
    publique%
}]{pki}{PKI}{\textit{Public Key Infrastructure}}
